...
5. Find the "Claude Code" add-on and click on it
6. Click "Install"
...
Claude Code is particularly useful for Home Assistant tasks. Here are some example uses:
