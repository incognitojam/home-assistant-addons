# Claude Code Add-on: Interactive Session Picker - Development Status

## Project Overview
Implementing an interactive session picker feature for the Claude Code Home Assistant add-on that allows users to choose how to launch Claude (new session, continue, resume, custom command, or shell access).
