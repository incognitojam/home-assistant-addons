...
A fork of the [Home Assistant Community Add-on: Tailscale](https://github.com/hassio-addons/addon-tailscale) providing a zero config VPN for building secure networks. This app installs Tailscale on your Home Assistant instance, creating a secure network between your servers, computers, and cloud instances.
